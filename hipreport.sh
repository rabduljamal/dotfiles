...
HOSTID="e9d3cfc5-88e5-4c4d-8b83-e1b4920bc96a"
case $CLIENTOS in
	Linux)
		CLIENT_VERSION="6.2.2-259"
		OS="Linux Fedora 32"
		OS_VENDOR="Linux"
		...
		<entry name="host-info">
			...
			<network-interface>
				<entry name="$NETWORK_INTERFACE_NAME">
					...
					<mac-address>1c:69:7a:a7:32:f7</mac-address>
					<ip-address>
						<entry name="$IP"/>
					</ip-address>
					<ipv6-address>
	...
	*) cat <<EOF
		<entry name="antivirus">
			<list>
				<entry>
					<ProductInfo>
						<Prod name="McAfee LiveSafe – Internet Security" version="16.0 R48" defver="26.3" prodType="3" engver="4928.0" osType="1" vendor="McAfee, Inc." dateday="8" dateyear="2023" datemon="8">
						</Prod>
				...
				<entry>
					<ProductInfo>
						<Prod name="Windows Defender" version="4.18.24020.7" defver="1.407.608.0" prodType="3" engver="1.1.24020.9" osType="1" vendor="Microsoft Corporation" dateday="21" dateyear="2024" datemon="3">
						</Prod>
						<real-time-protection>yes</real-time-protection>
	...
	*) cat <<EOF
		<entry name="disk-backup">
				<list>
					<entry>
						<ProductInfo>
							<Prod name="Microsoft OneDrive" version="24.045.0303.0003" vendor="Microsoft Corporation">
							</Prod>
					...
					<entry>
						<ProductInfo>
							<Prod name="Windows File History" version="10.0.22621.1" vendor="Microsoft Corporation">
							</Prod>
							<last-backup-time>n/a</last-backup-time>
						</ProductInfo>
					</entry>
					<entry>
						<ProductInfo>
							<Prod name="Windows Backup and Restore" version="10.0.22621.1" vendor="Microsoft Corporation">
							</Prod>
							<last-backup-time>n/a</last-backup-time>
						</ProductInfo>
					</entry>
